...
-- AddForeignKey
ALTER TABLE "reservation_reservation_option" ADD CONSTRAINT "reservation_reservation_option_reservationOptionId_fkey" FOREIGN KEY ("reservationOptionId") REFERENCES "reservation_option"("id") ON DELETE CASCADE ON UPDATE CASCADE;
